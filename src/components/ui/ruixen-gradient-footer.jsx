...
// Converted from the original TypeScript component to plain JS for this project.
...
// Stops, floor (0) → top (1): dark ember → blue → near-white → yellow
...
export function RuixenGradientFooter({
  ...
  useEffect(() => {
    ...
    // on a real page and inside a docs preview iframe alike.
  ...
  return (
    ...
    >
      ...
      {/* Fixed to the viewport — a transformed/filtered ancestor would capture
          it. Give the footer a plain containing block. */}
      <div
        ref={bandRef}
        aria-hidden
        style={{
